   ...
   'use strict'
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        ...
        if(retina) {
            $('.header .logo').find('img').attr({src:'./images/logo.png',width:'184',height:'50'});
            $('.footer-widgets .widget .textwidget').find('img').attr({src:'./images/logo-footer.png',width:'184',height:'50'});
